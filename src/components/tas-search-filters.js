...
import TasServicesSelector from './tas-services-selector';
import TimeFilterButton from './time-filter-button';
import TimeSelector from './time-selector';


class TasSearchFilters extends Component {
  constructor( props ) {
    super( props );
...
export default TasSearchFilters;

TasSearchFilters.propTypes = {
