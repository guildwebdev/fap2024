...
import TasSearchFilters from "../components/tas-search-filters";
...
class TasSearch extends Component {
  constructor(props) {
    super(props);
  ...
  onClearFilters() {
    this.setState({
      ...
      // After state is updated, get filtered results and update filteredLocations
      const filteredResults = this.getFilteredResults(this.state.locations);
      this.setState({
        filteredLocations: filteredResults
      });
    });
  }
